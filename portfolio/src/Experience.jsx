        ...
        <section className={styles['experience']}>
            ...
            <article className={styles['education']}>
                <div className={styles['education-container']}>
                    ...
                    <CredentialsFrame title={'Full Stack Web Engineer'} source={'Codecademy'} date={'May 2025'} description={['Developed fundamental knowledge and skills of Full Stack development.', 'Gained Proficiency In Back-End Frameworks like Express, Node, and PSQL.', 'Applied knowledge to create dynamic full stack web applications.']} />
                </div>
            </article>
            <article className={styles['skills']}>
                <div className={styles['skills-container']}>
                    <h2><span>Skills</span></h2>
                    <div className={styles['skills-grid']} style={{transitionDelay: '100ms'}}>
            ...
            <article className={styles['professional-experience']}>
                <div className={styles['professional-experience-container']}>
                    ...
                    <CredentialsFrame title={'Web Developer (Freelance)'} source={'New York Auto Museum'} date={'May 2025 - Present'} description={['Assist in the recreation and development of NYC Auto Museum Website.']} />
                </div>
            </article>
